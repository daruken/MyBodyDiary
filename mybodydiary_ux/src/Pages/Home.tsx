...
const Home = () => {
  ...
  const openLoginModal = () => { setIsShowLogin(true) }
  const closeLoginModal = () => { setIsShowLogin(false) }

  const openSignupModal = () => { setIsShowSignup(true) }
  const closeSignupModal = () => { setIsShowSignup(false) }
